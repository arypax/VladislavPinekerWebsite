            ...
            <div className='list-item' id='welcome'>
                <div className='welcome-content'>
                    <div className='welcome-text'>
                        ...
                        <div className='about-me-info'>
                            ...
                            <p><span className='span-title'>{translations.social}</span>
                                <span>
                                    <a href="https://www.instagram.com/vladislav.pineker/"><img src="/img/icons/instagram.png" alt="Instagram" className="social-icon" /></a>
                                    <a href="https://www.linkedin.com/in/vladislav-pineker/"><img src="/img/icons/linkedin.png" alt="LinkedIn" className="social-icon" /></a>
                                    <a href="https://t.me/vladislav_pineker"><img src="/img/icons/telegram.png" alt="Telegram" className="social-icon" /></a>
                                    <a href="https://github.com/arypax"><img src="/img/icons/github.png" alt="GitHub" className="social-icon" /></a>
                                    <a href="https://hh.kz/resume/92d4b32bff0b93dac70039ed1f396f316d4737"><img src="/img/icons/headhunter.png" alt="HeadHunter" className="social-icon" /></a>
                                </span>
                            </p>
                        </div>
                    ...
                    <div className='welcome-image'>
                        <img src='/img/vlad.png' alt='Vladislav Pineker' />
                    </div>
                </div>
            </div>
                ...
                <div className='portfolio-right'>
                    <div className='portfolio-grid'>
                        <div className='portfolio-image'>
                            <img src='/img/portfolio/parabellum menu.png' alt='Portfolio Image 1' />
                        </div>
                        <div className='portfolio-image'>
                            <img src='/img/portfolio/parabellum game1.png' alt='Portfolio Image 2' />
                        </div>
                        <div className='portfolio-image'>
                            <img src='/img/portfolio/parabellum game2.png' alt='Portfolio Image 3' />
                        </div>
                        <div className='portfolio-image'>
                            <img src='/img/portfolio/parabellum game3.png' alt='Portfolio Image 4' />
                        </div>
                    </div>
                </div>
            </div>
