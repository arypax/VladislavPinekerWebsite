        ...
        <nav className='navbar'>
            <ul className='navbar-list'>
                ...
                <div className='navbar-right'>
                    ...
                    <li className='navbar-item'>
                        <img className='slider-language' src="/img/icons/eng.png" alt="English" onClick={() => handleToggleLanguage('en')} />
                        <img className='slider-language' src="/img/icons/ru.png" alt="Russian" onClick={() => handleToggleLanguage('ru')} />
                    </li>
                </div>
            </ul>
        </nav>
